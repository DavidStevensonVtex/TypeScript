// Listing 20.4 The contents of the data.js file in the webapp folder
...
module.exports = function () {
    return {
        products: [
            ...
            { id: 8, name: "Unsteady Chair", category: "Chess", description: "Secretly give your opponent a disadvantage", price: 29.95 },
            { id: 9, name: "Human Chess Board", category: "Chess", description: "A fun game for the family", price: 75 },
            { id: 10, name: "Bling Bling King", category: "Chess", description: "Gold-plated, diamond-studded King", price: 1200 }
        ],
        orders: []
    };
}